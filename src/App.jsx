...
export default function App() {
  const [colorLeft, setColorLeft] = useState("#0093E9");
  const [colorRight, setColorRight] = useState("#80D0C7");
    ...
    <div className="min-h-screen bg-white p-4 md:p-10 font-sans text-slate-900">
      <div className="max-w-5xl mx-auto">
        <header className="mb-8">
          <h1 className="text-4xl font-black tracking-tight italic">LUMINA</h1>
          <p className="opacity-60">Master the art of CSS gradients.</p>
        </header>

        {/* PREVIEW BOX */}
        <div
          className="w-full h-52 md:h-80 rounded-3xl shadow-2xl mb-10 border-4 border-white transition-all duration-500"
          style={{
